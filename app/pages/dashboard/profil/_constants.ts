...
export const schema = z
  .object({
    ...
    anakKe: z.number().check(z.minimum(1, "Required")),
    dariBersaudara: z.number().check(z.minimum(1, "Required")),
    suku: z.string().check(z.minLength(1, "Required")),
    pendidikan: z.string().check(z.minLength(1, "Required")),
    pekerjaan: z.string().check(z.minLength(1, "Required")),
    jurusan: z.string().check(z.minLength(1, "Required")),
    tinggi: z.number().check(z.minimum(1, "Required")),
    berat: z.number().check(z.minimum(1, "Required")),
